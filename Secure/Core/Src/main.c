...
static void MX_GTZC_S_Init(void)
{
  ...
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_UART5, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_NPRIV) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_USART1, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_PRIV) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_ConfigPinAttributes(GPIOA, LED_RED_Pin|GPIO_PIN_13|GPIO_PIN_14, GPIO_PIN_NSEC);
